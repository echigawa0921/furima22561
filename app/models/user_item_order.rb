class UserItemOrder
  ...
  def save
    ...
    Jusyo.create(postal_code: postal_code, prefecture_id: prefecture_id, city: city, house_number: house_number, builing_name: builing_name,phone_number: phone_number)
  end
end
